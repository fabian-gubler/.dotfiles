...
This is due to the `hardware-configuration.nix`, which must be customized to the system's hardware. 
As a consequence, the following commands can be used for the configuration files to work.
